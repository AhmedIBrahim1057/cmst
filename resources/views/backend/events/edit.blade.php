                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="exampleInputBorder" placeholder="Enter the title" value="{{ $event->title }}">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <!-- Date -->
                        ...
                        <div class="col-md-7 pt-2">
                            ...
                            <div class="custom-file">
                                <input type="file" name="image" class="custom-file-input" id="customFile" value="{{ $event->image }}">

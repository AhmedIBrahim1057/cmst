                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="exampleInputBorder" placeholder="Enter the title" value="{{ $news->title }}">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <!-- Date -->
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="text" name="date" class="form-control datetimepicker-input" data-target="#reservationdate"/ value="{{ $news->date }}">
                        ...
                        <div class="col-md-7 pt-2">
                            ...
                            <div class="custom-file">
                                <input type="file" name="image" class="custom-file-input" id="customFile" value="{{ $news->image }}">
                                <label class="custom-file-label" for="customFile">{{ $news->image }}</label>
                            </div>
                        </div>
